...
window.addEventListener('DOMContentLoaded',() => {
    ...
    function showTabContent(i = 0) { // default value for i
    ...
    function getZero(num) {         // add 0 before num < 10 
        if (num >= 0 && num < 10) {
            return`0${num}`;
        } else {
            return num;
    ...
    function setClock(selector, endtime) {
        ...
        updateClock();      // fix timer first second blinking
